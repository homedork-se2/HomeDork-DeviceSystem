...
void deviceControllerCallback() {
    ...
    //Server
    //unencrypt the message..//FUTURE WORk...
    //send the unencrypted*FUTURE... message to the device controller to determine which device to be used
